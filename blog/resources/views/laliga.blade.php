...
<body>
    ...
    <header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      ...
      <a class="btn btn-outline-primary" href="/new">New Post</a>
    </header>
    
    <main class="container">
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">LaLiga Blog</h1>
        <p class="lead">The Campeonato Nacional de Liga de Primera División,[a] commonly known as La Liga[b] (LaLiga Santander for sponsorship reasons with Santander), stylized as LaLiga, is the men's top professional football division of the Spanish football league system. Administered by the Liga Nacional de Fútbol Profesional, is contested by 20 teams, with the three lowest-placed teams at the end of each season relegated to the Segunda División and replaced by the top two teams and a play-off winner in that division.</p>
      </div>
      ...
      <div class="row row-cols-1 row-cols-md-1 mb-3 text-center">
        <div class="col">
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg btn-outline-primary">Something</button>
          </div>
        </div>
        </div>
      </div>
